...
public class BlogResource {
    ...
    public BlogResource(BlogService blogService, BlogRepository blogRepository, UserRepository userRepository) {
    ...
    public Mono<ResponseEntity<Blog>> partialUpdateBlog(
        ...
        return blogRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Blog> result = blogService.partialUpdate(blog);
    ...
    public Mono<ResponseEntity<Blog>> getBlog(@PathVariable String id) {
        ...
        Mono<Blog> blog = blogService.findOne(id);
    ...
    public Mono<List<Blog>> searchBlogs(@RequestParam String query) {
        log.debug("REST request to search Blogs for query {}", query);
        return blogService.search(query).collectList();
    }
}
